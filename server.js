    ...
    const platformRows = ["ChatGPT","Claude","Gemini","Perplexity"].map(p => {
      ...
      return `
        <tr>
          ...
          <td style="font-family:'Bebas Neue',Impact,sans-serif;font-size:22px;padding:10px 16px;border-bottom:1px solid #1a1a1a;color:${color(sc)};text-align:right;">${sc}/100</td>
